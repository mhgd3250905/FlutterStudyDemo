...
class Douban {
  ...
  Douban.fromParams({this.count, this.start, this.total, this.title, this.subjects});

  factory Douban(jsonStr) => jsonStr == null ? null : jsonStr is String ? new Douban.fromJson(json.decode(jsonStr)) : new Douban.fromJson(jsonStr);

  Douban.fromJson(jsonRes) {
    count = jsonRes['count'];
    start = jsonRes['start'];
    total = jsonRes['total'];
    title = jsonRes['title'];
